...
const BLOC_EXTRAS: FieldConfig[] = [
  ...
  { name: 'chequesVacances', label: 'Chèques-vacances ANCV', case: 'CV', hint: 'Deux plafonds indépendants. Plafond fiscal (max déductible du bénéfice) — Plafond 2024 : 1 766 € · 2025 : 1 802 € · 2026 : 1 823 €. Plafond social (exo cotisations URSSAF + CARMF, = 30 % SMIC mensuel) — 2024 : 530 € · 2025 : 541 € · 2026 : 547 €. DSCN reçoit le montant commandé, dans la limite du plafond fiscal. 💡 **Frais d\'ouverture / d\'envoi ANCV** : à comptabiliser en **« Autres frais divers de gestion » (ligne 30 de la 2035-A, total BM)**, **PAS dans DSCN** (qui ne reçoit que le montant facial des chèques commandés).' },
