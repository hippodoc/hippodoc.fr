...
episodeNumber: 11
readTime: "10 min"
cover: "/blog/inbox-zero-remplacant-cover.jpg"
tags:
  - "Guide et Conseil"
...
faq:
  ...
  - question: "Comment fonctionne la règle des 3Q ?"
    answer: "À chaque sollicitation, pose-toi trois questions : **Quoi** (RAS, à faire ou urgent ?), **Qui** (toi, le secrétariat, le titulaire ?) et **Quand** (maintenant, aujourd'hui ou date précise ?). Si un des trois manque, tu crées de la charge mentale."
  - question: "Que signifie le tri rouge / jaune / vert ?"
    answer: "**Rouge** = action immédiate ou transmission urgente. **Jaune** = action nécessaire : si < 90 secondes tu fais, sinon tu crées une tâche datée. **Vert** = RAS, mais tracé dans le dossier avec une note courte puis archivé."
  - question: "Peut-on utiliser une messagerie classique pour échanger des données de santé ?"
    answer: "Non. Le CNOM recommande d'utiliser une **messagerie sécurisée de santé** comme **MSSanté** pour les échanges entre professionnels. Si une messagerie standard est utilisée, elle doit être sécurisée et adaptée à l'usage professionnel."
relatedArticles:
...
:::tip
"Résultat vu, pas d'action supplémentaire."\
"Message reçu, rappel programmé demain 18h10."\
"Point transmis au titulaire."\
"Contrôle à reprogrammer."\
Le but n'est pas d'écrire beaucoup. Le but est d'écrire assez pour que ni toi, ni quelqu'un d'autre, n'ayez à deviner ce qui était prévu.
:::
...
:::warning
L'IA peut être utile pour créer des trames de messages, des réponses administratives types, des check-lists, des formulations plus fluides, ou des prompts génériques réutilisables.\
**Règle nette : pas de données patient dans un outil grand public.** La CNIL recommande de ne jamais partager d'informations confidentielles ou personnelles dans un service grand public, et encourage l'usage de modèles d'entrée ou de prompts types pour cadrer les usages.\
La HAS et la CNIL indiquent, dans leur guide de bonnes pratiques 2026, que les contenus générés par un système d'IA et intégrés au dossier médical doivent être revus par le professionnel de santé qui prend en charge la personne.\
En pratique : utilise l'IA pour le générique, jamais pour déléguer ton jugement clinique, et jamais pour compenser un défaut de traçabilité.
:::
