...
seriesId: "divers"
readTime: "16 min"
cover: "/blog/requalification-remplacement-cover.jpg"
tags:
  - "Guide et Conseil"
cta: "Prêt à sécuriser tes remplacements ?"
faq:
  - question: "Un remplacement régulier peut-il être requalifié en collaboration ?"
    answer: "C'est juridiquement possible. Côté **juges civils**, la jurisprudence est plutôt rassurante : des remplacements réguliers de **7 ans** (CA Paris, 27 sept. 2012) et de **8 ans et demi** (CA Versailles, 18 mai 2020, confirmé par la Cour de cassation le 20 oct. 2021) n'ont **pas** été requalifiés. Côté **fisc**, le critère est différent : la **fréquence**. L'Ordre juge l'absence du remplacé, le fisc juge le caractère occasionnel — et l'un ne lie pas l'autre."
  - question: "Quels sont les risques si mon remplacement est requalifié ?"
    answer: "Selon le scénario : **collaboration libérale**, **contrat de travail** si un lien de subordination est établi (cotisations salariales rétroactives), **société créée de fait** (chacun devient responsable des dettes de l'autre), ou sanction **ordinale** pour gérance de cabinet interdite (art. R.4127-89 du Code de la santé publique). En pratique, le risque le plus fréquent est fiscal, et il a deux faces : la **TVA** sur la part conservée par le médecin remplacé, et — si tu es en **micro-BNC** — ton propre impôt, recalculé sur 100 % des honoraires."
  - question: "Pourquoi un remplaçant en micro-BNC peut-il être imposé sur de l'argent qu'il n'a pas touché ?"
    answer: "Requalifié en collaboration, tu es censé avoir encaissé **100 % de tes honoraires** et versé une **redevance** au titulaire. Au régime réel, cette redevance se déduit : l'opération est à peu près neutre. En **micro-BNC**, elle n'est pas déductible — elle est réputée couverte par l'abattement forfaitaire de 34 %. La part conservée par le cabinet reste donc dans ton assiette imposable."
  - question: "Un contrat validé par l'Ordre protège-t-il d'un redressement fiscal ?"
    answer: "**Non.** Les conditions du remplacement (absence du remplacé, caractère temporaire, contrat écrit et déclaré) sont celles de l'Ordre. Le fisc applique son propre critère : la part d'honoraires conservée par le remplacé n'échappe à la TVA que si le remplacement présente un **caractère occasionnel**. Une validation ordinale ne lie pas l'administration fiscale."
  - question: "Le seuil de TVA de 37 500 € sur les rétrocessions s'apprécie-t-il par remplaçant ou cumulé ?"
    answer: "Ni l'un ni l'autre côté remplaçant : **tes rétrocessions sont exonérées de TVA** (ce sont des soins, art. 261, 4-1° du CGI) — tu n'as aucun seuil de TVA à surveiller. Le sujet TVA concerne le **remplacé** : la part d'honoraires qu'il garde paie l'usage de son cabinet, et devient taxable si le remplacement n'est plus occasionnel. Le seuil de 37 500 € (montant 2026 en dessous duquel on ne facture pas de TVA) se calcule alors **chez lui, tout cumulé** — tous ses remplaçants et collaborateurs ensemble, pas contrat par contrat."
  - question: "Combien de temps peut-on remplacer le même médecin ?"
    answer: "Aucun texte ne fixe de durée maximale pour un médecin thésé inscrit à l'Ordre, ni de seuil chiffré de fréquence. Le Code de la santé publique exige seulement que le remplacement reste **temporaire** (art. R.4127-65) : le titulaire doit être réellement absent pendant tes jours de remplacement. Les repères des conseils départementaux varient d'un département à l'autre."
  - question: "Que faire si je reçois une proposition de rectification ?"
    answer: "Une proposition de rectification n'est **pas une condamnation**. Ne paie pas sans répondre : elle se conteste **par écrit, dans le délai indiqué**. Rassemble ton dossier (contrats, avis du conseil, justificatifs d'absence du titulaire, relevés bancaires) et fais-toi accompagner : syndicats, protection juridique, et avocat fiscaliste pour les gros enjeux."
  - question: "Quand faut-il passer du remplacement à la collaboration libérale ?"
    answer: "Quand la réalité ne colle plus au remplacement : le titulaire consulte **en même temps** que toi, la régularité est installée sans absence réelle, ou tu veux développer une **clientèle propre**. La collaboration libérale (loi du 2 août 2005) est le cadre prévu pour ça, avec un contrat type disponible auprès du Conseil de l'Ordre. À calculer avant : en collaboration, la redevance ne se déduit qu'au **régime réel**."
relatedArticles:
...
- **La régularité n'est pas interdite**, et les juges civils ne requalifient pas sur ce seul motif. Mais le fisc a son propre critère : le caractère **occasionnel** du remplacement.
- **Un contrat validé par l'Ordre ne te protège pas du fisc.** L'Ordre juge l'absence du remplacé, le fisc juge la fréquence — et l'un ne lie pas l'autre.
- Requalifié en collaboration, un remplaçant en **micro-BNC** est imposé sur **100 % des honoraires** : la part gardée par le cabinet devient une redevance qu'il ne peut pas déduire.
:::
...
**3. C'est écrit et déclaré.** [Contrat transmis au conseil départemental](/blog/signer-contrat-remplacement) avant le début, avec dates et conditions financières.
...
:::warning
**Ces trois conditions sont celles de l'Ordre. Le fisc, lui, applique un autre critère**, écrit dans sa propre doctrine : la part d'honoraires conservée par le remplacé n'échappe à la TVA que si le remplacement présente un **caractère occasionnel**. L'Ordre juge l'absence du remplacé ; le fisc juge la fréquence. Et une validation ordinale ne lie pas l'administration fiscale.
:::
...
1. **Collaboration libérale** — la relation relève du statut créé par la loi du 2 août 2005 : tu verses au titulaire une redevance (un loyer pour l'usage de son cabinet) et tu peux te faire une clientèle propre. Conséquences surtout fiscales (voir plus bas).
...
:::tip
**Devant le juge civil, la régularité seule ne requalifie pas.** Remplacer le même médecin chaque semaine, même pendant des années, n'a pas suffi. Ce qui fait basculer, c'est le **faisceau d'indices** : titulaire présent en même temps, subordination, partage des charges, clientèle propre. Mais ces décisions tranchent des litiges **entre confrères** : elles ne disent rien de ce que l'administration fiscale, elle, retient.
:::
...
:::warning
**Le seuil de 37 500 € se calcule chez le remplacé, tout cumulé.** Il se calcule **par professionnel, toutes recettes taxables additionnées** — les retenues sur tous ses remplaçants, ses éventuelles redevances de collaboration, etc. Ce n'est **pas** un seuil « par remplaçant » ni « par contrat ». Montants 2026 : 37 500 €, tolérance jusqu'à 41 250 €, le projet de seuil unique à 25 000 € ayant été abrogé (loi n° 2025-1044 du 3 novembre 2025).
:::
...
C'est exactement ce qui arrive au remplaçant du cas-type : rétrocession à 75 %, requalification, et les 25 % conservés par le cabinet traités comme une redevance qu'il aurait « versée » — ajoutés à ses recettes, abattement de 34 %, puis impôt, majorations et intérêts de retard sur trois années. Or [le micro-BNC](/blog/regime-fiscal-micro-bnc-vs-reel) est le régime de la majorité des remplaçants. C'est là que se niche la phrase qui fait mal : **imposé sur de l'argent jamais touché**.
...
:::warning
💡 **La vérité qui dérange : un contrat validé par l'Ordre ne te protège pas du fisc.** L'Ordre juge l'absence du remplacé, le fisc juge la fréquence — et l'un ne lie pas l'autre.
:::
...
1. Le titulaire **consulte en même temps** que toi — il n'y a plus d'absence à couvrir.
...
:::tip
Ce genre de dossier se joue sur des pièces datées. Avec **Hippodoc**, chaque remplacement laisse une trace propre : contrat, rétrocession, facture, période — tout est rangé au même endroit, avec ses dates, et exportable le jour où on te demande de justifier ton cadre d'exercice. Essai gratuit 30 jours. 🚀
:::
