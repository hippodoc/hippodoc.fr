...
description: "Remplacer le même médecin chaque semaine peut-il être requalifié en collaboration ? Ce que disent les juges, le vrai risque TVA, et comment te protéger."
pubDate: "2026-08-23"
...
Tu remplaces le même médecin tous les jeudis depuis un an, et tu te demandes si ça peut te retomber dessus. Réponse courte : la requalification d'un remplacement régulier est **juridiquement possible**, mais les juges l'ont **refusée** dans des affaires portant sur 7 ans et même 8 ans et demi de remplacements réguliers — tant que le cadre du remplacement était réellement respecté. Le vrai point de vigilance est ailleurs, et il est fiscal : la **TVA sur la part d'honoraires conservée par le médecin remplacé** quand le remplacement n'est plus « occasionnel ». On déroule tout, sources à l'appui. ⚖️

## 🔹 Le remplacement est temporaire par nature

Le Code de la santé publique pose le principe : un médecin ne peut se faire remplacer que **temporairement** (art. R.4127-65). Le remplacement suppose donc une **absence réelle** du titulaire — congés, formation, maladie, jour de repos hebdomadaire — pendant laquelle tu prends sa place auprès de **sa** patientèle, avec [un contrat écrit transmis au conseil départemental de l'Ordre](/blog/signer-contrat-remplacement).

À l'inverse, l'article R.4127-89 interdit à un médecin de **faire gérer son cabinet par un confrère**. C'est la ligne rouge : un « remplacement » où le titulaire n'est jamais absent, ou consulte en même temps que toi, n'est plus un remplacement — c'est un exercice conjoint qui devait prendre une autre forme (collaboration, association, salariat).
...
C'est le point le plus important — et le plus rassurant :
...
:::essentiel
**La régularité seule ne requalifie pas.** Remplacer le même médecin chaque semaine, même pendant des années, n'a pas suffi aux juges pour requalifier. Ce qui fait basculer, c'est le **faisceau d'indices** : titulaire présent en même temps, subordination, partage des charges, clientèle propre. Tant que chaque jour de remplacement correspond à une absence réelle et que ton indépendance est entière, le cadre tient.
:::
...
## ✅ Checklist anti-requalification

Si tu restes en remplacement régulier, verrouille le cadre :
...
:::tip
La meilleure protection, c'est un dossier tenu au fil de l'eau. Avec **Hippodoc**, chaque remplacement laisse une trace propre : contrat, rétrocession, facture, période — tout est daté, classé et exportable le jour où on te demande de justifier ton cadre d'exercice. 🚀
:::

## 📚 Sources (vérifiées au 23 août 2026)

• Code de la santé publique, art. R.4127-65 (remplacement) et R.4127-89 (interdiction de gérance) — Légifrance.\
• Loi n° 2005-882 du 2 août 2005, art. 18 (collaboration libérale) ; contrats types du CNOM (conseil-national.medecin.fr).\
...
• BOFiP : rescrit BOI-RES-TVA-000056 (TVA des rétrocessions en remplacement) et BOI-TVA-CHAMP-30-10-20-10 (professions médicales).\
