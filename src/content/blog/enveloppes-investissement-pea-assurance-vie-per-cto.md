...
episodeNumber: 12
readTime: "12 min"
cover: "/blog/enveloppes-investissement-cover.jpg"
tags:
  - "Guide et Conseil"
...
faq:
  ...
  - question: "Comment fonctionne le délai de 5 ans du PEA ?"
    answer: "Le compteur de 5 ans du PEA **démarre à la date du premier versement**, pas à la signature du contrat. Avant 5 ans, un retrait entraîne en principe la clôture du plan. Après 5 ans, les gains sont **exonérés d'impôt sur le revenu** (prélèvements sociaux dus) et les retraits partiels sont possibles sans fermeture."
  - question: "L'assurance-vie est-elle un bon outil de transmission ?"
    answer: "Oui, mais il faut distinguer deux régimes. **Avant 70 ans**, chaque bénéficiaire profite d'un abattement de 152 500 €. **Après 70 ans**, un abattement global de 30 500 € s'applique aux primes versées, puis les règles successorales classiques reprennent. La **clause bénéficiaire** doit être soigneusement rédigée."
  - question: "Le PER est-il toujours intéressant pour un médecin libéral ?"
    answer: "Pas automatiquement. Le PER permet de **déduire les versements du revenu imposable**, mais la sortie sera fiscalisée. L'intérêt est réel si tu déduis dans une **tranche élevée aujourd'hui** et que tu sors avec une pression fiscale plus faible à la retraite. Si tu es peu imposé, l'avantage peut être faible voire nul. **Le PER se calcule, il ne s'achète pas au feeling.**"
relatedArticles:
