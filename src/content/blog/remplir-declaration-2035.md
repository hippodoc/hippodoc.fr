...
episodeNumber: 6
readTime: "7 min"
cover: "/blog/remplir-declaration-2035-cover.png"
tags:
  - "Fiche Fiscalité"
cta: "Prêt à simplifier ta déclaration 2035 ?"
faq:
  - question: "Qui doit remplir la déclaration 2035 ?"
    answer: "La déclaration 2035 concerne les professionnels libéraux au **régime réel**. Si tu es en micro-BNC, tu n'as pas besoin de remplir la 2035 : tu déclares uniquement ton CA sur le formulaire 2042-C-PRO."
  - question: "Quelle est la différence entre 2035 et 2042 ?"
    answer: "La **2035** détaille tes recettes et charges professionnelles (régime réel). La **2042-C-PRO** reporte ton bénéfice sur ta déclaration personnelle d'impôt. En micro-BNC, tu remplis seulement la 2042-C-PRO."
  - question: "Quelle est la date limite pour déposer la 2035 ?"
    answer: "La 2035 se télétransmet **en mai** : échéance légale le 2e jour ouvré après le 1er mai, avec 15 jours de délai en télétransmission (**20 mai** en 2026). Tu peux la déposer en ligne sur impots.gouv.fr ou via ton AGA/expert-comptable."
  - question: "Faut-il obligatoirement un expert-comptable pour la 2035 ?"
    answer: "Non, ce n'est pas obligatoire mais **fortement recommandé** : la 2035 est complexe et un comptable sécurise ta déclaration. En revanche, adhérer à une association de gestion agréée ne donne **plus d'avantage fiscal** : la majoration des non-adhérents a disparu à partir des revenus 2023, et la loi de finances pour 2025 a supprimé la réduction d'impôt pour frais de comptabilité ainsi que l'agrément de ces organismes."
relatedArticles:
...
- La 2035 ne concerne que le **régime réel** ; en micro-BNC, tu remplis seulement la 2042-C-PRO.
- Les indemnités journalières vont en **ligne 6**, les cotisations sociales et les contrats Madelin en **ligne 25**.
- Le bénéfice de la **ligne 46** se reporte sur ta 2042-C-PRO.
- Dépôt en ligne **autour du 20 mai** (20 mai 2026 pour les revenus 2025).
:::
...
La déclaration 2035 concerne les professionnels libéraux au **régime réel**. Elle permet de déclarer tes recettes et dépenses professionnelles afin de calculer ton **bénéfice imposable**. Ce bénéfice sera ensuite reporté sur ta déclaration personnelle (formulaire **2042 C-PRO**).

## 🧾 Guide étape par étape pour remplir ta déclaration 2035

Les lignes ci-dessous sont celles du formulaire 2035-A, dans l'ordre où tu les remplis.



## 1️⃣ Informations personnelles

**Code d'activité professionnelle** : renseigne le code correspondant à ton activité médicale
...
**Ligne 30** : Hippodoc, comptable, blanchissage, soutenance de thèse, cadeaux pro\
**Ligne 31** : Frais bancaires, agios, TPE

## 4️⃣ Finalise ta déclaration

**Ligne 33** : Total des charges\
**Ligne 34** : Excédent (recettes ligne 7 - charges ligne 33)\
**Ligne 36** : Réintégration des frais personnels (usage privé véhicule, téléphone)\
...
📅 **Autour du 20 mai** : 2e jour ouvré après le 1er mai, + 15 jours parce que tu télédéclares (20 mai 2026 pour les revenus 2025 — vérifie chaque année)\
✅ **En ligne** via impots.gouv.fr ou par ton comptable

## 💡 Astuce Hippodoc : simplifie ta gestion fiscale !

:::tip
Centralise facilement tes recettes, charges et justificatifs sur Hippodoc. Exporte tout en un clic. Simple, rapide, efficace ✨
:::
