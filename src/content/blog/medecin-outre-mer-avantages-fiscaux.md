...
episodeNumber: 13
readTime: "7 min"
cover: "/blog/medecin-outre-mer-cover.png"
tags:
  - "Guide et Conseil"
...
slides:
  ...
  - src: "/blog/medecin-outre-mer/slide-02.png"
    alt: "Levier n°1 — Abattement d'impôt sur le revenu DOM (30% / 40%)"
  - src: "/blog/medecin-outre-mer/slide-03.png"
    alt: "Levier n°2 — Régime social ultramarin de l'indépendant (100/75/50%)"
  - src: "/blog/medecin-outre-mer/slide-04.png"
    alt: "Levier n°3 — LODEOM : zéro charges patronales si tu emploies"
  - src: "/blog/medecin-outre-mer/slide-05.png"
    alt: "Le faux ami : ZFANG exclue pour les libéraux (sauf Mayotte)"
  - src: "/blog/medecin-outre-mer/slide-06.png"
...
## 🎯 Le décor en une phrase

Pour un médecin en DROM, les quatre vrais leviers sont : **l'abattement d'impôt sur le revenu**, **le régime social ultramarin de l'indépendant**, **la LODEOM** si le cabinet emploie du personnel, et à **Mayotte** une **zone franche globale à 100 %** qui s'ajoute au reste.

En revanche, la grande idée reçue — la ZFANG pour tous — est fausse : un médecin libéral BNC « classique » en Guadeloupe, Martinique, Guyane ou Réunion n'y a pas droit.

## 📊 1. L'abattement d'IR DOM : ta vraie carte de fidélité

Si tu es fiscalement domicilié dans un DROM, tu bénéficies chaque année d'une réduction automatique de ton impôt sur le revenu :
...
Tu as une secrétaire, une IDE collaboratrice, une assistante ? La **LODEOM** (loi d'orientation pour l'outre-mer) t'ouvre droit à une **exonération de charges patronales sur les salaires**, pour les employeurs de moins de 11 salariés, tous secteurs confondus — donc un cabinet médical rentre dans le champ.

Dans le barème de base :

**Exonération totale** jusqu'à **1,3 SMIC annuel**\
**Exonération dégressive** ensuite\
**Extinction** à **2,2 SMIC annuels**
...
Donc : un cabinet médical libéral classique en **Guadeloupe, Martinique, Guyane ou Réunion n'a pas la ZFANG**.

*Exception* : si tu développes une structure de health-tech, de logiciel médical, de R&D, ou une activité commerciale accessoire, le diagnostic peut changer.
:::

## 🏝️ 5. Mayotte : l'exception majeure depuis 2025

La **loi du 11 août 2025** de programmation pour la refondation de Mayotte a créé une **zone franche globale temporaire**, qui s'applique à **tous les secteurs**, y compris BNC, professions libérales et santé.

**Abattement 100 %** sur les bénéfices pendant **5 ans**\
**IR** : impositions 2025 à 2029\
**IS** : exercices clos à compter du 31 décembre 2025 jusqu'aux exercices ouverts à compter du 31 décembre 2029\
**CFE et taxe foncière bâtie** : années 2026 à 2030\
...
## 🏥 6. Les aides conventionnelles depuis 2026 (valables aussi en DROM)

Depuis le **1er janvier 2026**, un médecin primo-installé en zone sous-dense peut obtenir **10 000 € en ZIP**, **5 000 € en ZAC**, ou **3 000 € pour un cabinet secondaire en ZIP**. À quoi s'ajoute la **majoration du forfait médecin traitant** : **+50 % la 1ʳᵉ année, +30 % la 2ᵉ, +10 % la 3ᵉ**, puis **+10 % pérenne** pour les médecins installés en ZIP ou QPV.

Ces aides ne sont pas propres aux DROM, mais **la plupart des DROM sont classés en ZIP** : à vérifier sur le PAPS de ta région.
