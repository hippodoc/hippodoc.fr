...
export const caseopedia: CaseInfo[] = [
  ...
  },
  {
    ...
    formulaire: "DSFU (ex DS-PAMC)",
    description: "Montant des chèques vacances ANCV commandés sur l'année, dans la limite d'un SMIC mensuel brut (1 823 € en 2026) — sans le ramener toi-même à 547 €. L'URSSAF applique automatiquement l'exonération de cotisations URSSAF + CARMF dans la limite de 547 € (2026). La CSG-CRDS reste due sur ces 547 € — calcul automatique, rien à ajouter.\n\n⚠️ **À ne pas inscrire dans DSCN** : les **frais d'ouverture du compte ANCV** et les **frais d'envoi/port** ne se reportent **PAS** ici — ils vont en charges déductibles de la 2035-A (ligne L30 « Autres frais divers de gestion »).",
    quiRemplit: "Médecin ayant souscrit des chèques vacances ANCV",
    erreurFrequente: "Plafonner toi-même à 547 € au lieu d'inscrire le montant commandé (dans la limite d'un SMIC mensuel brut). Inscrire plus d'un SMIC mensuel brut. Renseigner un montant net. Inclure les frais d'ouverture/d'envoi dans DSCN (à mettre en charges 2035-A à la place).",
    certitude: "confirmed",
    categorie: "social",
    conseil: "Indiquer le montant brut commandé, dans la limite d'un SMIC mensuel brut (ex : 1 820 €, les chèques se commandant par multiples de 10 €) — **uniquement la valeur faciale des chèques**, jamais les frais annexes. L'URSSAF déduit l'exo sociale dans la limite de 547 € (2026). Le plafond fiscal (1 823 € en 2026, = 1 SMIC mensuel brut) est totalement indépendant et se gère côté 5HQ ou 5QC. Les frais d'achat ANCV (création de compte, frais d'envoi, commission) sont déductibles à 100 % en charges (ligne L30 de la 2035-A en réel ; noyés dans l'abattement 34 % en micro-BNC). Payer avec le compte pro pour la traçabilité.",
    relatedTerms: ["ancv"],
    relatedQuestions: ["QT-026"],
  ...
  },
  {
    ...
    description: "Ligne **CI** du cadre 7 « Divers à déduire » de la 2035-B. C'est ici qu'en **BNC réel** on déduit fiscalement les majorations PDSA exonérées (Art. 151 ter — CRN/CRM/CRD/VRN/VRM/VRD/VRS + forfaits PRN/PRD/RSP, plafond 60 jours). La PDSA reste comptabilisée dans les recettes 2035-A puis sortie via CI. Côté social, **CI figure dans la formule du RBS** (Cadre 8) → réintégration **AUTOMATIQUE** en **DSDE** (positif) ou **DSDG** (négatif).",
...
export const zonesGrises: ZoneGrise[] = [
  ...
  },
  {
    ...
    positionA: "Les majorations de garde PDSA (CRN, CRM, CRD, VRN, VRM, VRD, VRS) et les forfaits d'astreinte (PRN, PRD, RSP) sont exonérés d'impôt sur le revenu dans la limite de 60 jours de garde par an. L'exonération est accessible même en micro-BNC et transmissible aux remplaçants.",
  ...
  },
  {
    ...
    positionA: "Plusieurs actes et forfaits perçus PENDANT une garde régulée (constats de décès 100 €, réquisitions garde à vue, indemnité forfaitaire CPAM ≈ 75 € de régulation, cotation SNP de nuit profonde…) sont versés uniquement parce que tu es de garde. À ce titre, ils pourraient relever des « rémunérations perçues au titre de la permanence des soins » visées par l'Art. 151 ter du CGI, au même titre que les majorations CRN/CRM/CRD/VRN/VRM/VRD/VRS et les forfaits d'astreinte PRN/PRD/RSP.",
    positionB: "L'Art. 151 ter et le BOFIP (BOI-BNC-CHAMP-10-40-20) visent **limitativement** la **rémunération d'astreinte** (PRN, PRD, RSP) et les **majorations spécifiques de permanence des soins** du tableau conventionnel (CRN, CRM, CRD, VRN, VRM, VRD, VRS). La rémunération d'astreinte comprend expressément la « rémunération forfaitaire de régulation et d'astreinte » fixée par le cahier des charges de l'ARS (BOFiP, § 60). Le reste — forfait ARS constat de décès, réquisition préfectorale/judiciaire (base juridique distincte), SNP (majoration NGAP générique de nuit profonde) — reste imposable comme une recette libérale classique.",
    conclusion: "Le BOFiP tranche pour le forfait de régulation PDSA (§ 60, ci-dessous). Pour les autres cas, aucune position formelle BOFiP ni rescrit public connu. Par prudence, **règle commune : hors majorations spécifiques PDSA + rémunération d'astreinte et de régulation → imposable, sauf rescrit personnel**.\n\n• **Constats de décès (100 €)** — Forfait ARS, base juridique de réquisition distincte. Ne pas exonérer ; si tu le fais, prépare la justification du lien direct avec la PDS en cas de contrôle.\n\n• **Réquisitions garde à vue** — Réquisition préfectorale/judiciaire, hors NGAP. Ne pas exonérer.\n\n• **Forfait de régulation PDSA** (fixé par le cahier des charges de l'ARS, versé par la CPAM) — Exonérable : le BOFiP (BOI-BNC-CHAMP-10-40-20, § 60) le range dans la « rémunération forfaitaire de régulation et d'astreinte », dans la même limite de 60 jours et aux mêmes conditions de zone. Attention, une régulation **hors PDSA** (ex. régulation SAS en journée) ne relève pas de la permanence des soins : elle reste imposable.\n\n• **Cotation SNP (supplément nuit profonde)** — Majoration NGAP générique, pas spécifique à la PDS. Ne pas exonérer (risque de redressement sur assiette modeste mais réel). Hippodoc ne range pas le SNP dans les actes exonérables PDSA.\n\nDans tous les cas : si tu choisis d'exonérer, conserve un justificatif détaillé liant la rémunération à la garde régulée et envisage un rescrit personnel auprès de ton SIE.",
    certitude: "grey_zone",
    theme: "declarations",
