...
export const zonesGrises: ZoneGrise[] = [
  ...
  },
  {
    ...
    positionB: "L'Art. 151 ter et le BOFIP (BOI-BNC-CHAMP-10-40-20) visent **limitativement** la **rémunération d'astreinte** (PRN, PRD, RSP) et les **majorations spécifiques de permanence des soins** du tableau conventionnel (CRN, CRM, CRD, VRN, VRM, VRD, VRS). Tout ce qui n'y figure pas nommément — forfait ARS constat de décès, réquisition préfectorale/judiciaire (base juridique distincte), indemnité forfaitaire CPAM de régulation, SNP (majoration NGAP générique de nuit profonde) — reste imposable comme une recette libérale classique.",
